...
var Channel = function () {
  function Channel() {
    ...
    var transducer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (val) {
      return val;
    };
    var initialBuffer = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
  ...
  _createClass(Channel, [{
    ...
    value: function take() {
      ...
      return new Promise(function (resolve) {
        ...
        my.takers.push(function (message) {
          resolve(message);
          return true;
        });
        flush(_this2);
    ...
    value: function close() {
      ...
      try {
        for (var _iterator = my.takers[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var taker = _step.value;
      ...
      try {
        for (var _iterator2 = my.putters[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var putter = _step2.value;
    ...
    value: function map(fn) {
      ...
      return new Channel(my.bufferSize, function (val) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 1:
                ...
                _context.next = 4;
                return _asyncGenerator.await(this.take());
...
function open() {
  ...
  return new (Function.prototype.bind.apply(Channel, [null].concat(args)))();
}
...
function pub(input) {
  var pubSub = function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
      var _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, _value2, item, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, sub, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5, _sub;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 11:
              ...
              for (_iterator4 = subs[Symbol.iterator](); !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                sub = _step4.value;
            ...
            case 52:
              ...
              for (_iterator5 = subs[Symbol.iterator](); !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                _sub = _step5.value;
      ...
      }, _callee2, this, [[3, 38, 42, 52], [17, 21, 25, 33], [26,, 28, 32], [43,, 47, 51], [55, 59, 63, 71], [64,, 66, 70]]);
    }));
  ...
  return {
    ...
    unsub: function unsub(ch) {
      subs = subs.filter(function (val) {
        return val !== ch;
      });
    }
  };
...
var producer = function () {
    ...
    return function producer(_x) {
        return _ref2.apply(this, arguments);
    };
}();

var listener = function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(name, input) {
        ...
        }, _callee3, this, [[3, 20, 24, 34], [25,, 29, 33]]);
    }));
...
var _output = __webpack_require__(/*! ./output */ "./src/output.js");

var _chan = __webpack_require__(/*! ./chan */ "./src/chan.js");

var _util = __webpack_require__(/*! ./util */ "./src/util.js");

var _lift = __webpack_require__(/*! ./lift */ "./src/lift.js");

var lift = _interopRequireWildcard(_lift);
...
var output = (0, _output.outputToElement)('output');
...
exports.fromEventById = exports.fromEvent = undefined;
...
exports.fromEventById = fromEventById;
...
exports.outputToElement = outputToElement;
